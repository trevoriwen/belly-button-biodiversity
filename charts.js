...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var selectedMetadataId = data.metadata.filter(data => data.id == sample);
    console.log(selectedMetadataId);
    ...
    var firstWFreq = selectedMetadataId[0].wfreq;
    console.log(firstWFreq);
    ...
    var washFreq = parseFloat(firstWFreq)
